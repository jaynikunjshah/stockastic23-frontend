            ...
            <div className='bg-[#7353BA] my-4 p-9 text-white mx-4 w-full lg:mx-[10rem] rounded-xl grid md:grid-cols-2 gap-5'>
              ...
              <div>
                ...
                <div className='mt-4 flex flex-col'>
                  ...
                  <a
                    href='https://chat.whatsapp.com/EpJdv07VBsHFvYDXlT8cWV'
                    target={'_blank'}
                    className='rounded-xl p-4 mx-auto bg-[#25D366] font-bold mt-5'
                  >
                    <div class='flex justify-center items-center'>
                      <img src='./whatsapp.svg' className='h-5 mr-2' />
