...
function Home() {
  ...
  return (
    <div id="home">
      <nav className="flex flex-wrap lg:w-full w-full backdrop-filter backdrop-blur-lg 
      bg-opacity-100 top-0 left-0 right-0 items-center justify-between p-3
       text-[#7C7C7C] max-w-screen xsnavadj:content-center xsnavadj:justify-center">
        <div className="lg:flex items-center mr-4 xsnavadj:mr-0">
          ...
          <div className="text-3xl font-extrabold ml-2 mt-4 tracking-[3px]">STOCKASTIC</div>
        </div>
        <div className="lg:flex lg:justify-center">
          <div className="w-full flex flex-row p-0">
            ...
            <div className="xsnavadj:mr-[0.5rem] xsnavadj:mt-4">
              <button className="px-4 py-2  transition duration-275 ease-in-out transform hover:scale-125 border-white text-[#0F0F0F] font-semibold rounded-full ml-4 bg-[#7353BA] hover:bg-purple-300  hover:shadow-md inline" onClick={() => {navigate("/signup")}}>
                REGISTER
              </button>
              <button className="px-4 py-2 border transition duration-275 ease-in-out transform hover:scale-125 border-white text-[#7C7C7C] font-semibold rounded-full ml-4  hover:shadow-md inline" onClick={() => {navigate("/signin")}}>
                LOGIN
              </button>
            </div>
          </div>
      ...
      <div className="md:order-3 md:w-1/2 md:mx-auto mb-4 text-center mt-[3%]">
        ...
        hover: font-semibold ml-4 hover:bg-purple-300 hover:text-[#0F0F0F] transition duration-275 ease-in-out transform hover:scale-110" onClick={() => {navigate("/signin")}}>
          REGISTER NOW
        </button>
      </div>
    </div>
