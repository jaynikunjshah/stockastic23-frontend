...
function AboutUs() {
	return (
		<div id="About-Us" className="grid lg:grid-cols-3 w-4/5 mx-auto mt-[100px] mb-[200px] text-white rounded-xl bg-[#7353BA] p-9 tracking-[1px]">
        ...
        <div className="mb-6 text-3xl text-[#d6d1d1]">About <span className="text-4xl font-bold text-[#0f1020]">STOCKASTIC</span></div>
