...
function AboutUs() {
  return (
    <div id="About-Us">
      <div
        className="grid lg:grid-cols-3 w-4/5 mx-auto mt-[100px] mb-[200px] text-white rounded-xl bg-[#7353BA] p-9 tracking-[1px]"
      >
        <img
        ...
        <div className="col-span-2 lg:translate-x-[-4rem]">
          ...
          <div className="text-xl text-[#d6d1d1]">
            ...
            sessions with industry experts to gain insights into the workings of
            the stock market. Register through our website for a nominal fee and
            join us for a thrilling event!
          </div>
        </div>
      </div>
    </div>
