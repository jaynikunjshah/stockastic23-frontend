            ...
            <div className="form text-center m-4">
              ...
              >
                ...
                <form noValidate onSubmit={handleSubmit} className="mt-[200px]">
                  ...
                  <button
                    type="submit"
                    className={`mx-[10%] w-[50%] px-4 py-3 mt-4 rounded-xl mb-6 hover:opacity-75 ${verifyingUser ? "bg-[#7353BA] opacity-75" : "bg-[#7353BA]"}`}
                  ...
                  <button
                    type="button"
                    onClick={resendOTP}
                    className={`mx-[10%] w-[50%] px-4 py-3 rounded-xl mb-[30px] hover:ring hover:ring-violet-100 ${resendingOTP ? "bg-[#1E1B1E] opacity-75" : "bg-[#1E1B1E]"}`}
