          ...
          <div className="login grid md:grid-cols-2 w-[100%] h-[100%]">
            <div className="form w-100 text-center m-4">
              ...
              <form noValidate onSubmit={handleSubmit}>
                <span className="block font-[500] text-2xl mt-[45px] mb-3">
                  CREATE AN ACCOUNT
                </span>
                ...
                <button
                  type="submit"
                  className="bg-[#7353BA] mx-[10%] w-[50%] -mt-4 px-4 py-3 rounded-xl mb-6 hover:opacity-75"
                >
                  Create Account
                </button>
                  <button
              ...
              <a href="mailto:dreammerchantsvit@gmail.com" className="flex bottom-4 w-fit">
