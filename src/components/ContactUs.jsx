  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Stockastic'23 Contact Us Page" />
      </Helmet>
      <div id="Contact-Us">
        <div className="mx-[25px] lg:px-0 px-6 rounded-[20px] grid lg:grid-cols-2 grid-cols-1 bg-[#7353BA]">
          ...
          <div className="m-auto lg:text-[1.7rem] text-[1.4rem] text-[#d6d1d1] mb-9 lg:my-9">
            {/* Information */}
            <div>
              <a className="font-semibold block mb-2 w-fit" href="#About-Us">
                About Stockastic
              </a>
              <a
        ...
        <div className="text-[#646464] font-bold text-[1.3rem] text-center mt-1 mb-2">
          <span className="align-middle text-[2.4rem]">©</span>
          <span className="align-middle">
            Dream Merchants VIT-2023 - All Rights Reserved.
          </span>
        </div>
      </div>
    </>
