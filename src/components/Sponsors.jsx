...
function Sponsors() {
  return (
    <>
      <div className='bg-sand h-screen flex justify-between med:flex-col med:items-center tall:h-full'>
        ...
        <div className='flex justify-center items-center flex-col w-2/4 med:w-full'>
          <span className='text-blue_shade font-bold font-Lora text-5xl m-8 med:text-3xl'>OUR SPONSORS</span>
